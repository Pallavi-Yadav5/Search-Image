...
const App = () => {
  ...
  return (
    <div>
        ...
        <h1 className='text-xl font-bold text-white mr-7'>Search Images</h1>
        <input className="bg-gray-50 border border-gray-300 text-sm indent-2 p-2.5 outline-none focus:border-blue-500 focus:ring-2 rounded-tl rounded-bl" type="text" placeholder="Search Anything..." onChange={(e) => setQuery(e.target.value)}/>
